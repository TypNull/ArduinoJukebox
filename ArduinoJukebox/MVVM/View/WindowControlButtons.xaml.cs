...
namespace ArduinoJukebox.MVVM.View
{
    ...
    public partial class WindowControlButtons : UserControl
    {
        public WindowControlButtons()
        {
            ...
            MinimizeCommand = new RelayCommand(o => window.WindowState = WindowState.Minimized);
            MaximizeCommand = new RelayCommand(o => { window.WindowState = window.WindowState != WindowState.Maximized ? WindowState.Maximized : WindowState.Normal; });
